      ...
      <div className=" text-gray-800 min-h-screen py-10 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-lg text-center mb-10">
            Welcome to <span className="font-semibold">Homely</span>, your
            trusted real estate marketplace designed to bridge the gap between
            landlords and potential tenants or buyers. With Homely, we eliminate
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 space-y-3">
              ...
              <li>
                ...
                search properties based on location, price range, type, and
                more, making it easier to find the perfect match.
              </li>
              <li>
              ...
              <li>
                <strong>Verified User Profiles & Reviews:</strong> Enhances
                trust by ensuring all users and properties are authenticated and
          ...
          <section>
            ...
            <p className="text-lg leading-relaxed">
              At HomeHub, we aim to redefine the real estate experience by
              making it more accessible, transparent, and efficient for
              everyone. Whether you're a landlord looking to list your property
              or a tenant/buyer searching for your next home, HomeHub is here to
              make it happen with ease.
            </p>
          </section>
          <div className="flex flex-col md:grid grid-cols-1 md:grid-cols-2 gap-7 mt-6">
            <img
              src={house1}
              alt=""
              className="w-full md:w-[500px] h-auto md:h-[500px] rounded-xl"
            />
            <img
              src={house3}
              alt=""
